...
const i18n = {
  fr: {
    ...
    text: {
      ...
      ".service-item:nth-of-type(2) h3": "Stage en pâtisserie",
      ".service-item:nth-of-type(2) p": "Participation à la production de macarons, éclairs, fraisiers, flans, petits fours, ganaches, mousses, viennoiseries et préparations salées, des pesées au montage en passant par le pétrissage, la cuisson et l'organisation du poste.",
  ...
  en: {
    ...
    text: {
      ...
      ".atelier-copy h2": "Learning the right techniques, practicing them, and building consistency.",
      ...
      ".service-item:nth-of-type(2) h3": "Pastry internship",
      ".service-item:nth-of-type(2) p": "Contributed to the production of macarons, eclairs, fraisier cakes, flans, petits fours, ganaches, mousses, viennoiserie and savory items, from weighing and mixing to baking, assembly and station organization.",
